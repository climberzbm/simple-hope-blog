      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-12">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm text-center">
            ...
            <p className="text-sm text-gray-500">前端开发 · 跨端技术 · AI 应用</p>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm text-center">
            <div className="text-3xl mb-2">💡</div>
        ...
        {aboutContent ? (
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-sm">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p>👋 你好，欢迎来到我的博客！</p>
              <p>我是一名<strong>前端开发工程师</strong>，热爱技术，专注于 Web 开发和跨端技术。</p>
              
              <h3>🛠️ 技术栈</h3>
              <ul>
                <li><strong>前端：</strong>Vue3、React、TypeScript、Tailwind CSS</li>
                <li><strong>跨端：</strong>小程序、UniApp、React Native</li>
                <li><strong>后端：</strong>Node.js、Koa、Prisma</li>
                <li><strong>工程化：</strong>Vite、Webpack、CI/CD</li>
                <li><strong>AI：</strong>大模型应用、Prompt 工程</li>
              </ul>
